...
function Inventory() {
  ...
  const fetchSearchData = () => {
    fetch(`http://localhost:4002/api/product/search?searchTerm=${searchTerm}`)
      .then((response) => response.json())
      .then((data) => {
        setAllProducts(data);
      })
  ...
  const deleteItem = (name) => {
    ...
    console.log(`http://localhost:4002/api/product/delete/${name}`);
    fetch(`http://localhost:4002/api/product/delete/${name}`)
      .then((response) => response.json())
      .then((data) => {
                  ...
                  <tr key={element._id}>
                    ...
                    <td className="whitespace-nowrap px-4 py-2 text-gray-700 text-center">
                      ...
                      <span
                        ...
                        onClick={() => deleteItem(element.name)}
                      >
                        Delete
                      </span>
                    </td>
